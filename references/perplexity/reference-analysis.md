# Reference analysis — perplexity

- URL: https://example.com/perplexity
- Title: Perplexity
- Date: 2026-09-12T01:07:17Z
- Total score: 50 / 100
...
| Layout complexity (scroll=1000px, sections=0) | 10 / 22 |
| CTA clarity (9 CTAs) | 12 / 12 |
| Visual system (colors=7, fonts=1, shadows=4, radii=9) | 11 / 15 |
...
WATCH — capture only, not a premium demo

Run:
> ai-factory@0.0.1 factory:create /home/sgy/ai-factory
> tools/factory/factory-create.sh https://example.com/perplexity

Factory create: https://example.com/perplexity -> references/example-com/
Step 1: detailed capture
Capturing https://example.com/perplexity
...
Extracting design signals from https://example.com/perplexity
